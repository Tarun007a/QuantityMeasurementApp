package com.qma_microservices.auth_service.exception;

import com.qma_microservices.auth_service.AuthServiceApplication;
...
public class GlobalExceptionHandler {
    ...
    private final AuthServiceApplication application;

    GlobalExceptionHandler(AuthServiceApplication application) {
