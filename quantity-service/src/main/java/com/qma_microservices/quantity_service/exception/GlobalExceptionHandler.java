...
import com.qma_microservices.quantity_service.QuantityServiceApplication;
...
public class GlobalExceptionHandler {
    ...
    private final QuantityServiceApplication application;

    GlobalExceptionHandler(QuantityServiceApplication application) {
